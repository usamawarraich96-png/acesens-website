...
export function DigitalMarketingArt({ className }: ArtProps) {
  ...
  return (
    <svg viewBox="0 0 400 240" className={className} preserveAspectRatio="xMidYMid slice" aria-hidden>
      ...
      <g opacity="0.5" stroke="#4FA3F5" strokeWidth="0.5">
        {[60, 120, 180].map((y) => (
      ...
      <g transform="translate(96 128)">
        <circle r="26" fill="none" stroke="#1c3355" strokeWidth="9" />
        <circle
          r="26"
          fill="none"
          stroke="url(#art-blue)"
  ...
  return (
    <svg viewBox="0 0 400 240" className={className} preserveAspectRatio="xMidYMid slice" aria-hidden>
      ...
      <polyline
        ...
        opacity="0.7"
      />
      <path d="M372 60 l-14 2 l6 8 Z" fill="#4FA3F5" opacity="0.9" />

      {/* pedestal */}
      <ellipse cx="150" cy="196" rx="70" ry="12" fill="#12233d" />

      {/* product box (isometric) */}
      <g transform="translate(150 150)" stroke="url(#art-blue)" strokeWidth="2" strokeLinejoin="round">
        <path d="M-40,-8 L0,-28 L40,-8 L0,12 Z" fill="#12294a" />
        <path d="M-40,-8 L-40,34 L0,54 L0,12 Z" fill="#0e2140" />
        <path d="M40,-8 L40,34 L0,54 L0,12 Z" fill="#0b1c36" />
        <path d="M0,12 L0,-6 M-20,-13 L20,-13" stroke="#4FA3F5" strokeWidth="1.5" opacity="0.6" />
      </g>

      {/* stars */}
      <g transform="translate(255 150)" fill="#4FA3F5">
        {[0, 1, 2, 3, 4].map((i) => (
          <path
            key={i}
      ...
      <text x="255" y="120" fontSize="13" fill="#9FB0C6">
        Best Seller
      </text>
    </svg>
  )
...
export function AISystemsArt({ className }: ArtProps) {
  return (
    <svg viewBox="0 0 400 240" className={className} preserveAspectRatio="xMidYMid slice" aria-hidden>
      ...
      {/* circuit traces */}
      <g stroke="#274a72" strokeWidth="1.5" fill="none">
      ...
      <g transform="translate(200 120)">
        <rect x="-52" y="-46" width="104" height="92" rx="14" fill="#0e2340" stroke="url(#art-blue)" strokeWidth="2" />
        {/* chip pins */}
        <g stroke="#4FA3F5" strokeWidth="2">
          {[-30, -10, 10, 30].map((x) => (
        ...
        {[
          ...
          <circle key={i} cx={x} cy={y} r="2.2" fill="#4FA3F5" />
        ))}
      </g>
    </svg>
  )
